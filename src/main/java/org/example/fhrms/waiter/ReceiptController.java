...
// cookedTimeColumn.setCellValueFactory(cellData ->
// cellData.getValue().cookedTimeProperty());
...
// Order selectedOrder =
// completedOrdersTable.getSelectionModel().getSelectedItem();

// if (selectedOrder == null) {
// showAlert("No Order Selected", "Please select a completed order to generate a
// receipt.",
...
// receiptBuilder.append("Order ID:
// ").append(selectedOrder.getOrderId()).append("\n");
// receiptBuilder.append("Customer Name:
// ").append(selectedOrder.getCustomerName()).append("\n");
// receiptBuilder.append("Cooked Time:
// ").append(selectedOrder.getCookedTime()).append("\n");
...
// private void showAlert(String title, String content, Alert.AlertType
// alertType) {
